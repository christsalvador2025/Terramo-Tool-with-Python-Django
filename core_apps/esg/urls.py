...
urlpatterns = [
    ...
    path('dashboard/client-admin/', ESGDashboardViewSet.as_view({'get': 'client_admin_dashboard'}), name='esg-client-admin-dashboard'),
    path('dashboard/stakeholder/', ESGDashboardViewSet.as_view({'get': 'stakeholder_dashboard'}), name='esg-stakeholder-dashboard'),
    path('dashboard/client/<uuid:client_id>/', ESGDashboardViewSet.as_view({'get': 'client_detail'}), name='esg-client-detail'),
